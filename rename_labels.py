# filepath: /home/windbow/Workspace/sfenizer/rename_labels.py
import os
import shutil
...
for label_file in os.listdir(labels_dir):
    if label_file.endswith('.txt'):
        ...
        if len(parts) > 1:
            new_name = parts[1]  # e.g., 'MVIMG_20251202_223500.txt'
            if new_name.rsplit('.', 1)[0] in image_names:  # Check if base name matches an image
